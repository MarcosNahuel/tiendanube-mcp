...
export function registerUpdateProduct(server: McpServer) {
  server.tool(
    'update_product',
    'Actualiza atributos de un producto (precio/stock de variantes, nombre, descripción, tags, publicación). Las variantes se pasan en el array `variants` con su id. Retorna el producto actualizado.',
    {
